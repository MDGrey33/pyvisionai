...
class TestFileExtraction:
    ...
    def setup_method(self):
        ...
        if os.path.exists(self.log_dir):
            self.existing_logs = {f for f in os.listdir(self.log_dir) if f.endswith('.log')}
    ...
    def run_extraction(self, file_type):
        ...
        assert result.returncode == 0, f"{file_type.upper()} extraction should complete successfully"
