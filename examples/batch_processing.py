...
class BatchProcessor:
    ...
    def process_file(self, input_path: str, output_dir: str) -> Tuple[str, bool, str]:
        """
        ...
        try:
            ...
            file_output_dir = os.path.join(output_dir, filename.replace(".", "_"))
            ...
            return filename, True, f"Processed successfully: {output_path}"
